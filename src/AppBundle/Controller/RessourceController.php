...
class RessourceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('AppBundle:ressource:index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('AppBundle:ressource:new.html.twig', array(
            'ressource' => $ressource,
    ...
    public function editAction(Request $request, Ressource $ressource)
    {
        ...
        return $this->render('AppBundle:ressource:edit.html.twig', array(
            'ressource' => $ressource,
